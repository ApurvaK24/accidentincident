...
function Login() {
  ...
  const [email, setEmail] = useState(''); // Change employeeId to email
  const [password, setPassword] = useState('');
  const [selectedOption, setSelectedOption] = useState('');
  const [errorMessages, setErrorMessages] = useState({
    email: '', // Change employeeId to email
    password: '',
    selectedOption: '',
  });
  ...
  const validateForm = () => {
    ...
    if (!email) {
      isValid = false;
      errors.email = 'Email is required'; // Change employeeId to email
    }
  ...
  const handleLogin = () => {
    ...
    const data = {
      Email: email, // Change employeeId to email
      Password: password,
